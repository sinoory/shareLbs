...
var BusAuthSchema = mongoose.Schema({
        mobinfo : {type : String, default : ''},
        //showid=hash(mobinfo)
        mobStuctinfo:{},//sub json
        userid : {type : String, default : ''},
        nickname : {type: String,default :''},
        verifycode : {type : String, default : ''},
        // guest(not payed) ||normal(payed) || root() || manager
        authtype: {type : String,default : 'guest'},
        paydate     : {type : Date},
        addate     : {type : Date},//first use net date
        accesscnt      : {type : Number},
        linestatus : {type : String, default : 'offline'}, //online, offline
        saysay : {type : String, default : ''},
        imgs : [] ,//userid1.png ...
});
...
var mo = new AuthDbOpr("busAuthDb",BusAuthSchema,"BusAuth");
mo.init();
module.exports = mo;
